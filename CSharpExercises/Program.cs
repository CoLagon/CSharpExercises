...
namespace CSharpExercises
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(Exercises.PrintTimesTable(9));
            Assert("ConvertKelvinToFahrenheit(300) should return 80.33", Exercises.ConvertKelvinToFahrenheit(300) == 80.33);
            Console.WriteLine(Exercises.ConvertKelvinToFahrenheit(300));
            ...
            Console.WriteLine(Exercises.GetAverageHard(new int[] { 10, 20, 30, 40, 50, 60, 80 }));
            ...
            Console.WriteLine(Exercises.CollatzConjecture(27));
            ...
            Console.WriteLine(Exercises.MortgageCalculator(300000, 3.8, 30, 12));
            Assert("DuckGoose(100) should print correctly", Exercises.DuckGoose(100) == Constants.DuckGooseResult);
            Console.WriteLine(Exercises.DuckGoose(100));
            /* Prompt user to exit */
